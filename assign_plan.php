 ...
 mysql_set_charset('utf8');
  ...
  if( !empty( $_REQUEST['lang']) && $_REQUEST['lang'] != '' ){
    ...
    if(table_exists($table)){
      $query  = mysql_query("SELECT FieldNo ,$table  FROM $table WHERE ScreenNo='005'");
...
<html lang="en" class="no-js">
	...
	<div id="planpiper_wrapper"class="fullheight">
		 ...
		 <div class="col-sm-8 paddingrl0" id="content_wrapper">
		 	...
		 	<div id="pageheading" 
		 	style="<?php if(isset($AssignPatient)){echo 'height:65px';}?>">
		 		Select a Plan from Plan List on the right & Assign it to a Patient<br><?php if(isset($AssignPatient) &&  $AssignPatient !=''){echo '('.$AssignPatient.')';}?></div>
			</div>
		 	<section>
		 		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="mainplanlistdiv">
								...
								<div class="col-lg-offset-1 col-lg-10 col-lg-offset-1 col-md-offset-1 col-md-10 col-md-offset-1 col-sm-12 col-xs-12" style="margin-top:2%;margin-bottom:2%;">
									<div class="bigplanbox">
										...
										<div class="selectaplan">Select A Plan -><br><?php if(isset($SelectAPlan) &&  $SelectAPlan !=''){echo '('.$SelectAPlan.')';}?></div>
									</div>
								</div>
									<div align="left" class="col-lg-offset-1 col-lg-10 col-lg-offset-1 col-md-offset-1 col-md-10 col-md-offset-1 col-sm-12 col-xs-12">
										<div class="col-lg-4 col-sm-4 col-md-12 col-xs-12 bigtextdiv">
											Select a Patient:
											<br><?php if(isset($SelectaPatient) &&  $SelectaPatient !=''){echo '('.$SelectaPatient.')';}?>
										</div>
									...
									<div align="left" class="col-lg-offset-1 col-lg-10 col-lg-offset-1 col-md-offset-1 col-md-10 col-md-offset-1 col-sm-12 col-xs-12">
										<div class="col-lg-4 col-sm-4 col-md-12 col-xs-12 bigtextdiv margintop10">
											Doctor Name:
											<br><?php if(isset($DoctorName) &&  $DoctorName !=''){echo '('.$DoctorName.')';}?>
										</div>
									...
									<div align="left" class="col-lg-offset-1 col-lg-10 col-lg-offset-1 col-md-offset-1 col-md-10 col-md-offset-1 col-sm-12 col-xs-12" style="margin-top:10px;">
										<div class="col-lg-4 col-sm-4 col-md-12 col-xs-12 bigtextdiv">
											Select the Disease :
											<br><?php if(isset($SelecttheDisease) &&  $SelecttheDisease !=''){echo '('.$SelecttheDisease.')';}?>
									...
									<div align="left" class="col-lg-offset-1 col-lg-10 col-lg-offset-1 col-md-offset-1 col-md-10 col-md-offset-1 col-sm-12 col-xs-12" style="margin-top:5px;">
										<div class="col-lg-4 col-sm-4 col-md-12 col-xs-12 bigtextdiv">
											Medical Record :
											<br><?php if(isset($MedicalRecord) &&  $MedicalRecord !=''){echo '('.$MedicalRecord.')';}?>
										</div>
										<div class="col-lg-8 col-sm-8 col-md-12 col-xs-12">
								...
								<!--  style="position: fixed;bottom: 0;background-color: #fff;text-align: center;left:0;"-->
								 <div id="ActionBar2" class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top:20px;">
							        <button type="button" id="assigntouser" class="btns formbuttonsmall">ASSIGN <?php if(isset($ASSIGN) &&  $ASSIGN !=''){echo '('.$ASSIGN.')';}?></button>
							        <button type="button" id="cancelbutton" class="btns formbuttonsmall">RESET <?php if(isset($RESET) &&  $RESET !=''){echo '('.$RESET.')';}?></button>
							      </div>
								</div>
		 	</section>
		 </div>
		 ...
		 <div style="height:100%;overflow:scroll;overflow-x:hidden;">
		 	<div style="font-size: 135%;" id="rightmenuheading">Plan List <?php if(isset($PlanList) &&  $PlanList !=''){echo '('.$PlanList.')';}?></div>
		 	<?php 
		 		...
		 		if($get_active_plans_count > 0){
		 			...
		 			echo "<div id='sidebartext'>No active plans. <a href='generate_plancode.php' style='color:#fff;border-bottom:1px dotted #fff;text-decoration:none;'>Add</a> a plan to assign.</div>";
		 		}
		 	?>
		 </div>
     		</div>
	...
	$(document).ready(function() {
        ...
        $('#topbar-leftmenu').click(function(){
          ...
          if(sidebarflag == 1){
              ...
              $('#content_wrapper').removeClass("col-sm-8");
              sidebarflag = 0;
          } else {
              $('#sidebargrid').show("slow","swing");
              $('#content_wrapper').addClass("col-sm-8");
	...
	foreach ($userarray as $user) {
		...
		if($assigned_to_user > 0){
			...
			if($check_user_exists_count==0)
			{
				...
				//echo $insert_default_settings;exit;
