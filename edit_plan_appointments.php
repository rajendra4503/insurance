...
if((isset($_REQUEST['hidden_value']))&&(!empty($_REQUEST['hidden_value']))){
	...
	$delete_user_header = mysql_query("delete from APPOINTMENT_HEADER where  PlanCode = '$current_created_plancode'");
	$delete_user_details = mysql_query("delete from APPOINTMENT_DETAILS where  PlanCode = '$current_created_plancode'");	
	}
	...
	$datearray = array();
	$get_previous_dates = mysql_query("select AppointmentDate from USER_APPOINTMENT_HEADER where PlanCode = '$current_created_plancode' and UserID='$assigned_to_user'");
    ...
    <div class="col-sm-2 paddingrl0"  style="display:none;" id="sidebargrid">
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingrl0">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<ul class="nav nav-pills nav-justified">
					...
					<li role="presentation" class="active navbartoptabs"><a href="plan_appointments.php">APPOINTMENT</a></li>
    	...
    	<div class="col-lg-10 col-md-9 col-sm-9 col-sm-12 maincontent">
	    	<div id="dynamicPagePlusActionBar">
	    		<form name="frm_edit_appointments" id="frm_edit_appointments" method="post" action="">
			      ...
			      <tr id="aheader">
			        ...
			        <?php 
			        	if(isset($appo_edit_id)){
			        		$appo_count = 0;
				   			$appo_count_string = "";
				   		$get_appodetails_to_edit = mysql_query("select `PlanCode`, `AppointmentDate`, `AppointmentTime`, `AppointmentShortName`, `DoctorsName`, `AppointmentRequirements` from APPOINTMENT_DETAILS where PlanCode = '$current_created_plancode'");
