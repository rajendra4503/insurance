...
$prescno  = "1";
$prescription_name = "";
$get_presc_header = mysql_query("select PrescriptionName, DoctorsName from MEDICATION_HEADER where PrescriptionNo = '$prescno' and PlanCode = '$plancode'");
...
?>
<form name="frm_plan_prescription" id="frm_plan_prescription" method="post" action="plan_med_new.php" enctype="multipart/form-data">
    ...
    <div class="table-responsive" style="float:left;width:99%;padding-bottom:100px;">
        ...
        <?php
        $get_presc = "select `PlanCode`, `PrescriptionNo`, `RowNo`, `MedicineName`, `MedicineCount`, `MedicineTypeID`, `ThresholdLimit` , `When`, `SpecificTime`, `Instruction`, `Frequency`, `FrequencyString`, `HowLong`, `HowLongType`, `IsCritical`, `ResponseRequired`, `StartFlag`, `NoOfDaysAfterPlanStarts`, `Link`, `OriginalFileName`, `SpecificDate` from MEDICATION_DETAILS where PlanCode='$plancode' and PrescriptionNo = '$prescno'";
        //echo $get_presc;exit;
...
while ($medicines = mysql_fetch_array($get_medicines)) {
    ...
    $medicine_options   .= "<option value='$brand_name' selected>$display_name</option>";      
    }
    else {
        $medicine_options   .= "<option value='$brand_name'>$display_name</option>";      
    } 
        ...
        ?>
            <tr style="border-top:4px solid #004f35;">
                <td class="paddingrl5" align="center" colspan="6">
                    <!-- <textarea rows="1" name="medicine<?php //echo $i;?>" id="medicine<?php echo $i;?>" placeholder="Enter Medicine Name.." maxlength="100" title="Enter Medicine Name here" style="height:40px;width:100%;"><?php //echo $MedicineName;?></textarea> -->
                    ...
                    <select style="height:35px;width:100%;background-color:#2B6D57;" name="medicine<?php echo $i;?>" id="medicine<?php echo $i;?>" class='forminputs2'>
                        <option value="" style="display:none;">Select a Medicine</option>
                        <?php
                        echo $medicine_options_exist;
                        }
                        else
                        {
                        ?>
                    </select>   
                    <input type="text" list="medicine_list"  id="medicine<?php echo $i;?>" name="medicine<?php echo $i;?>" placeholder="
                    <?php if(isset($TypeMedicineNameHere) &&  $TypeMedicineNameHere !=''){echo $TypeMedicineNameHere;} else{echo 'Type Medicine Name Here';}?>
                    " class='forminputs2' value='<?php echo $MedicineName;?>'> 
                ...
                <td style="width:300px;" class="paddingrl5">
                    <input type="radio" name="radio<?php echo $i;?>" value="PS" checked class="radio<?php echo $i;?> prescriptionradio" <?php echo $PlanStartRadio;?>>
                    <?php if(isset($WhentheplanStarts) &&  $WhentheplanStarts !=''){echo $WhentheplanStarts;} else{echo ' When the plan Starts/Updates';}?>
                    <br>
                </td>
                <td>
                    <img src="images/closeRow.png" width="25px" height="auto" class="deleterow" id="<?php echo $i;?>" title="Delete this row">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="center"><?php if(isset($Critical) &&  $Critical !=''){echo $Critical;} else{echo 'Critical : ';}?><input type="checkbox" name="critical<?php echo $i;?>" id="critical<?php echo $i;?>" class="criticalcheck" title="Check this if the medicine is critical" value="Y" style="margin-left:5px;" <?php echo $CriticalSelect;?>></td>
            ...
            <tr>
                <td colspan="8">
                    ...
                    <div class="bottomshadow" style="width:100%;color:#fff;pointer-events:none;height:12px;">
            ...
            <tr style="border-top:4px solid #004f35;">
                ...
                ?>
                <input type="text" list="medicine_list"  id="medicine<?php echo $j;?>" name="medicine<?php echo $j;?>" placeholder="<?php if(isset($TypeMedicineNameHere) &&  $TypeMedicineNameHere !=''){echo $TypeMedicineNameHere;} else{echo 'Type Medicine Name Here';}?>" class='forminputs2'> 
                <datalist id="medicine_list">
                <?php echo $medicine_options;?>
                </datalist>
                <?php
                ...
                <td>
                    <img src="images/closeRow.png" width="25px" height="auto" class="deleterow" id="<?php echo $j;?>" title="Delete this row">
                </td>
            </tr>
            <tr>
                <td class="paddingrl5" align="left"><?php if(isset($When) &&  $When !=''){echo $When;} else{echo 'When :';}?></td>
            ...
            <tr>
                <td align="center"><?php if(isset($Critical) &&  $Critical !=''){echo $Critical;} else{echo 'Critical : ';}?><input type="checkbox" name="critical<?php echo $j;?>" id="critical<?php echo $j;?>" class="criticalcheck" title="Check this if the medicine is critical" value="Y" style="margin-left:5px;"></td>
...
<button type="button" id="addMedicine" class="btns formbuttons"><?php if(isset($ADDAMEDICINE) &&  $ADDAMEDICINE !=''){echo $ADDAMEDICINE;} else{echo 'ADD A MEDICINE ';}?></button>
