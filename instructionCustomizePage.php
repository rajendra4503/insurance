...
<?php 
  ...
  <?php
  $get_presc = "select `PlanCode`, `PrescriptionNo`, `RowNo`, `MedicineName`, `InstructionTypeID`, `When`, `SpecificTime`, `Instruction`, `Frequency`, `FrequencyString`,`ThresholdLimit`, `HowLong`, `HowLongType`, `IsCritical`, `ResponseRequired`, `StartFlag`, `NoOfDaysAfterPlanStarts`, `Link`, `OriginalFileName`, `SpecificDate` from USER_INSTRUCTION_DETAILS where PlanCode='$plancode' and PrescriptionNo = '$prescno' and UserID = '$userid'";
  //echo $get_presc;exit;
