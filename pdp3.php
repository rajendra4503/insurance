...
$medicine_options   .= "<option value='$medicine_name'>$medicine_name</option>";       
}
}
...
?>
<form name="frm_plan_prescription" id="frm_plan_prescription" method="post" action="plan_med_new.php">
    ...
    <div class="table-responsive" style="float:left;width:99%;padding-bottom:100px;">
        ...
        <?php
        $get_presc = "select `PlanCode`, `PrescriptionNo`, `RowNo`, `MedicineName`, `MedicineCount`, `MedicineTypeID`, `ThresholdLimit` , `When`, `SpecificTime`, `Instruction`, `Frequency`, `FrequencyString`, `HowLong`, `HowLongType`, `IsCritical`, `ResponseRequired`, `StartFlag`, `NoOfDaysAfterPlanStarts`, `Link`, `SpecificDate` from MEDICATION_DETAILS where PlanCode='$plancode' and PrescriptionNo = '$prescno'";
        //echo $get_presc;exit;
        ...
        ?>
            ...
            <tr>
                <td align="center">Critical :<input type="checkbox" name="critical<?php echo $i;?>" id="critical<?php echo $i;?>" class="criticalcheck" title="Check this if the medicine is critical" value="Y" style="margin-left:5px;" <?php echo $CriticalSelect;?>></td>
                ...
                <td colspan="4" style="white-space:nowrap;"><input type="text" name="linkentered<?php echo $i;?>" id="linkentered<?php echo $i;?>"  class="forminputs2" title="Enter Link here" placeholder="Enter Link Here (Optional)" value='<?php echo $Link;?>' style='width:90%'></td>
            ...
            <tr>
                ...
                <td colspan="4" style="white-space:nowrap;">Link:<input type="text" name="linkentered<?php echo $j;?>" id="linkentered<?php echo $j;?>" value="" class="forminputs2" title="Enter Link here" placeholder="Enter Link Here (Optional)" style='width:90%'></td>
...
var mednamedisplay = "";
if(browser_name == "applesafari"){
mednamedisplay = "<select style='height:35px;width:100%;background-color:#2B6D57;' name='medicine"+propercount+"' id='medicine"+propercount+"'><option value='' style='display:none;'>Select a Medicine</option><?php echo $medicine_options;?></select>";
}else {
