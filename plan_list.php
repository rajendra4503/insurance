...
<html lang="en" class="no-js">
  ...
  <div id="planpiper_wrapper">
     ...
     <div class="col-sm-10 paddingrl0" id="content_wrapper">
      ...
      <span style="padding-left:148px;">My Master Plans <?php if(isset($MyMasterPlans) &&  $MyMasterPlans !=''){echo '('.$MyMasterPlans.')';}?></span><?php if($logged_roleid !=4){?><a href="generate_plancode.php" style="color:#004f35;text-decoration:none;"><button type="button" class="btns" align="right" id="finished_adding">Add New Plan <?php if(isset($AddNewPlan) &&  $AddNewPlan !=''){echo '('.$AddNewPlan.')';}?></button></a><?php }?></div></div>
        ...
        <a href="plan_list.php?lang=<?php echo $lang ;?>" style="color:#000;text-decoration:none;">
          <span class="planfilters active">Active Plans <?php if(isset($ActivePlans) &&  $ActivePlans !=''){echo '('.$ActivePlans.')';}?></span>
          
        </a>

        <a href="pendingplans.php?lang=<?php echo $lang ;?>" style="color:#000;text-decoration:none;"><span class="planfilters">Pending Plans<?php if(isset($PendingPlans) &&  $PendingPlans !=''){echo '('.$PendingPlans.')';}?></span>
        </a>

        <a href="deactivatedplans.php?lang=<?php echo $lang ;?>" style="color:#000;text-decoration:none;"><span class="planfilters">Deactivated Plans<?php if(isset($DeactivatedPlans) &&  $DeactivatedPlans !=''){echo '('.$DeactivatedPlans.')';}?></span>
        </a>

        <a href="assignedplans.php?lang=<?php echo $lang ;?>" style="color:#000;text-decoration:none;"><span class="planfilters">Assigned Plans<?php if(isset($AssignedPlans) &&  $AssignedPlans !=''){echo '('.$AssignedPlans.')';}?></span>
        </a>
            ...
            while ($plan_details = mysql_fetch_array($get_active_plans)) {
             ...
             <div class="smallplanbox">
                    ...
                    <div class="onhoveroptions">
                      <div class="onhoveroption assignplanbutton" id="<?php echo $plan_code;?>">Assign <?php if(isset($Assign) &&  $Assign !=''){echo '('.$Assign.')';}?></div>
                      <?php if($logged_roleid !=4){?>
                      <div class="onhoveroption editplanbutton" id="<?php echo $plan_code;?>">Edit <?php if(isset($Edit) &&  $Edit !=''){echo '('.$Edit.')';}?></div>
                      <div class="onhoveroption deactivateplanbutton" id="<?php echo $plan_code;?>">Deactivate <?php if(isset($Deactivate) &&  $Deactivate !=''){echo '('.$Deactivate.')';}?></div>
                      <?php }?>
                    </div>
                  </div>
              <?php
  ...
  $(document).ready(function() {
        ...
        $('.deactivateplanbutton').click(function(){
          ...
          //bootbox.alert(plancode);
          var deact;
          bootbox.confirm("This plan will be deactivated. Click OK to continue", function(result) {
            deact = result;
          if(deact == true){
              ...
              success : function (response)
                { 
                  bootbox.alert("Plan successfully deactivated.");
