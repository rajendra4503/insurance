...
if((isset($_REQUEST['delete_id'])) && (!empty($_REQUEST['delete_id']))){
  ...
  if( !empty( $_REQUEST['lang']) && $_REQUEST['lang'] != '' ){
    ...
    if(table_exists($table)){
      $query  = mysql_query("SELECT FieldNo ,$table  FROM $table WHERE ScreenNo='009'");
...
<html lang="en" class="no-js">
	...
	<div id="planpiper_wrapper">
		 ...
		 <div class="col-sm-10 paddingrl0" id="content_wrapper">
		 	...
		 	<section>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingrl0"><div id="plantitle">Add A Medicine <?php if(isset($AddAMedicine) &&  $AddAMedicine !=''){echo '('.$AddAMedicine.')';}?></div></div> 
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingrl0" align="center" style="margin-top:10px;margin-bottom:10px;">
    		<div style="height:50px;width:35%;border:1px solid #004f35;line-height:50px;border-radius:10px;cursor:pointer;color:#004f35;font-size:18px;" class="button addmedicinebutton"><img src='images/add_green.png' height="18px" width="auto" style="margin-top:-5px;">&nbsp;&nbsp;<strong>ADD A MEDICINE <?php if(isset($AddAMedicine) &&  $AddAMedicine !=''){echo '('.$AddAMedicine.')';}?></strong></div>
    </div>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingrl0" align="center" style="margin-bottom:5px;">
    	<input type="text" placeholder="SEARCH MEDICINE <?php if(isset($SEARCHMEDICINE) &&  $SEARCHMEDICINE !=''){echo '('.$SEARCHMEDICINE.')';}?>" name="search_medicine" id="search_medicine" style="padding-left:10px;"  onkeypress='keychk(event)' <?php if((isset($_REQUEST['query'])) && (!empty($_REQUEST['query']))){ $query = $_REQUEST['query']; echo "value='$query'";}?>>
      <?php 
        if((isset($_REQUEST['query'])) && (!empty($_REQUEST['query']))){
          ?>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingrl0" id="mainplanlistdiv">      
              ...
              <tr class="tableheadings" style="height:45px;">
                <th>#</th>
                <th>Medicine Name <br><?php if(isset($MedicineName) &&  $MedicineName !=''){echo '('.$MedicineName.')';}?></th>
                <th>Date Added <br><?php if(isset($DateAdded) &&  $DateAdded !=''){echo '('.$DateAdded.')';}?></th>
                <th>Action <br><?php if(isset($Action) &&  $Action !=''){echo '('.$Action.')';}?></th>
              </tr>
              <?php 
                  if((isset($_REQUEST['query'])) && (!empty($_REQUEST['query']))){
            ...
            <div class="modal" id="addmedicinemodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
              <div class="modal-dialog" style="width:750px;">
                <div class="modal-content">
                  ...
                  <h5 class="modal-title" id="modalheadings" style="background-color:#004f35;color:#F2BD43;">ADD A MEDICINE <?php if(isset($AddAMedicine) &&  $AddAMedicine !=''){echo '('.$AddAMedicine.')';}?></h5>
                  </div>
                    	...
                    	<div align="left" style="padding-left:5px;font-family:RalewayRegular;color:#004f35;font-weight:600;margin-top:30px;">
            						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingrl0">
            							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingrl0" style="margin-bottom:10px;">
            								<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 ">
            									GENERIC NAME:<br><?php if(isset($GENERICNAME) &&  $GENERICNAME !=''){echo '('.$GENERICNAME.')';}?>
            								</div>
            							...
            							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingrl0" style="margin-bottom:10px;">
            								<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 ">
            									BRAND NAME:<br><?php if(isset($BRANDNAME) &&  $BRANDNAME !=''){echo '('.$BRANDNAME.')';}?>
            								</div>
                            ...
                            <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12 paddingr0">
                              <span style="display:none;" class="massinputs">mg</span>
            							...
            							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingrl0" style="margin-bottom:10px;">
            								<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 ">
            									COMPANY NAME:<br><?php if(isset($COMPANYNAME) &&  $COMPANYNAME !=''){echo '('.$COMPANYNAME.')';}?>
            								</div>
            								<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 ">
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 errormessages" align="center">
            ...
            <button type="button" id="addtodirectory" class="directorybuttons">ADD <?php if(isset($ADD) &&  $ADD !=''){echo '('.$ADD.')';}?></button>
            <button type="button" id="cancelbutton" class="directorybuttons">CANCEL <?php if(isset($CANCEL) &&  $CANCEL !=''){echo '('.$CANCEL.')';}?></button>
       	  </div>
              	</div>
              </div>
            </div>
