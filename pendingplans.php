	...
	<div id="planpiper_wrapper">
     ...
     <!--<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingrl0"><div id="plantitle">My Plan Lists<a href="create_plan.php" style="color:#004f35;text-decoration:none;"><button type="button" class="btns" align="right" id="finished_adding">Add New Plan</button></a></div></div>-->
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingrl0" id="plantitlelight" style="font-size: 14px;">
        ...
        <a href="pendingplans.php?lang=<?php echo $lang ;?>" style="color:#000;text-decoration:none;"><span class="planfilters active">Pending Plans <?php if(isset($PendingPlans) &&  $PendingPlans !=''){echo '('.$PendingPlans.')';}?></span></a>
        <a href="deactivatedplans.php?lang=<?php echo $lang ;?>" style="color:#000;text-decoration:none;"><span class="planfilters">Deactivated Plans <?php if(isset($DeactivatedPlans) &&  $DeactivatedPlans !=''){echo '('.$DeactivatedPlans.')';}?></span></a>
