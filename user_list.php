...
<html lang="en" class="no-js">
    <head>
		...
		<title>Plan Piper - Healthcare Providers</title>
	...
	<div id="planpiper_wrapper">
       ...
       <?php
        ...
        {
        ?>
         <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingrl0"><div id="plantitle"><span style="padding-left:226px;">Admins <?php if(isset($Admins) &&  $Admins !=''){echo '('.$Admins.')';}?></span><a href="create_user.php" style="color:#004f35;text-decoration:none;"><button type="button" class="btns" align="right" id="finished_adding">Add a Healthcare Provider <?php if(isset($AddHealthcareProvider) &&  $AddHealthcareProvider !=''){echo '('.$AddHealthcareProvider.')';}?></button></a></div></div>
        <?php
        }
        ?>
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingrl0" id="plantitlelight">
        ...
        {
        ?>
        <a href="user_list.php?lang=<?php echo $lang ;?>" style="color:#000;text-decoration:none;"><span class="planfilters active">Admin</span></a>
        <?php
        }
        else
        {
        ?>
        <a href="user_list.php?lang=<?php echo $lang ;?>" style="color:#000;text-decoration:none;"><span class="planfilters active">Admins <?php if(isset($Admins) &&  $Admins !=''){echo '('.$Admins.')';}?></span></a>
        <a href="plan_creators.php?lang=<?php echo $lang ;?>" style="color:#000;text-decoration:none;"><span class="planfilters">Plan Creator <?php if(isset($PlanCreators) &&  $PlanCreators !=''){echo '('.$PlanCreators.')';}?></span></a>
        ...
        ?>
          ...
          <?php 
          //GET ADMINS
          $get_admins1 = "select distinct t1.UserID,t2.FirstName, t2.Lastname, t1.EmailID, concat('+', TRIM(LEADING '0' FROM t1.MobileNo)) as mobileno from USER_ACCESS as t1, USER_DETAILS as t2, USER_MERCHANT_MAPPING as t3 where t1.UserID = t2.UserID and t2.UserID = t3.UserID and t3.RoleID = '2' and t3.Status = 'A' and t1.UserStatus = 'A' and t3.MerchantID = '$logged_merchantid' order by t2.FirstName";
          //echo $get_admins1;exit;
          $get_admins  = mysql_query($get_admins1);
          ...
          if($admin_count > 0){
            ...
            echo "<tr class='tablecontents'><td colspan='5'>No Admins</td></tr>";
          }
        ?>
          </table>
          </div>
  ...
  $(document).ready(function(){
	...
	$(document).ready(function() {
        ...
        $('.deactivatethisuser').click(function(){
          ...
          var deact = confirm("This user will be deactivated. Click OK to continue");
          if(deact == true){
