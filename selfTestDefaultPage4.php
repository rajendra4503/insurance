   ...
   mysql_set_charset('utf8');
    if( !empty( $_SESSION['LANGUAGE']) && $_SESSION['LANGUAGE'] != '' ){
        ...
        if(table_exists($table)){
            $query  = mysql_query("SELECT FieldNo ,$table  FROM $table WHERE ScreenNo='014'");
      ...
      ?>
          ...
          <select name="selftestName<?php echo $i;?>" id="selftestName<?php echo $i;?>" style="width:100%;" class='testnameselect'>
            <option style="display:none;" value="select">
              ...
              <?php if(isset($SelectTestName) &&  $SelectTestName !=''){echo $SelectTestName;} else{echo 'Select Test Name';}?>
           ...
           <td style="padding:5px;" align="center" colspan="2">
            <textarea rows="1" name="selftestOther<?php echo $i;?>" id="selftestOther<?php echo $i;?>" placeholder=" <?php if(isset($EnterSelfTestName) &&  $EnterSelfTestName !=''){echo $EnterSelfTestName;} else{echo 'Enter Self Test Name..';}?>" maxlength="100" title="Enter Self Test Name" <?php echo $TestNameStyle;?>><?php echo $TestName;?></textarea>
          </td>
           <td style="padding:5px;" align="center" colspan="3">
            <textarea rows="1" name="doctorName<?php echo $i;?>" id="doctorName<?php echo $i;?>" placeholder="<?php if(isset($EnterDoctorName) &&  $EnterDoctorName !=''){echo $EnterDoctorName;} else{echo 'Enter Doctor Name.. ';}?>" maxlength="25" title="Enter Self Test Name" style="height:40px;width:100%;"><?php echo $DoctorsName;?></textarea>
          </td>
          <td style="width:300px;" style="padding:5px;">
            ...
            <?php if(isset($WhenStartsUpdates) &&  $WhenStartsUpdates !=''){echo $WhenStartsUpdates;} else{echo 'When the plan Starts/Updates';}?>
            <br>
          </td>
        ...
        <tr>
          ...
          <td style="padding:5px;" align="left"><?php if(isset($Instruction) &&  $Instruction !=''){echo $Instruction;} else{echo 'Instruction:';}?>
          </td>
          <td style="padding:5px;" align="center">
          ...
          <td style="padding:5px;" align="center"><?php if(isset($Frequency) &&  $Frequency !=''){echo $Frequency;} else{echo 'Frequency :';}?></td>
          <td style="padding:5px;" align="center">
          ...
          <td>
           <input type="radio" name="radio<?php echo $i;?>" value="ND" class="radio<?php echo $i;?> prescriptionradio" <?php echo $NumOfDaysRadio;?>> <?php if(isset($Noafterplanstarted) &&  $Noafterplanstarted !=''){echo $Noafterplanstarted;} else{echo 'No. Of days after plan started ';}?>&nbsp;<input type="text" size="6px" name="numofdays<?php echo $i;?>" id="numofdays<?php echo $i;?>" class="numofdays roundedinputs <?php if($StartFlag!= "ND"){echo "pointernone";}?>" maxlength="2" value='<?php echo $NoOfDaysAfterPlanStarts;?>'>
          </td>
        </tr>
        <tr>
          <td style="padding:5px;" align="center" colspan="7">
            <textarea rows="1" name="selftestdesc<?php echo $i;?>" placeholder="<?php if(isset($EnterRequirementsselftest) &&  $EnterRequirementsselftest !=''){echo $EnterRequirementsselftest;} else{echo 'Enter Requirements to selftest.. ';}?>" class="forminputs2" id="selftestdesc<?php echo $i;?>" style="height:40px;width:100%;"><?php echo $TestDescription;?></textarea>
          </td>
        ...
        <tr>
          <td>
            <td  style="padding:5px;"><?php if(isset($Link) &&  $Link !=''){echo $Link;} else{echo 'Link : ';}?></td>
           ...
           <td colspan="5" style="padding:5px;">
             <div class="fileinput fileinput-new input-group" data-provides="fileinput" style="width:100%;">
                      ...
                      <span class="input-group-addon btn btn-default btn-file"><span class="fileinput-new"><?php if(isset($ClickUploadDocument) &&  $ClickUploadDocument !=''){echo $ClickUploadDocument;} else{echo 'Click To Upload A Document ';}?></span><span class="fileinput-exists">Change</span><input type="file"  name="uploadedfile<?php echo $i;?>" id="uploadedfile<?php echo $i;?>"></span>
...
<tr style="border-top:4px solid #004f35;">
          ...
          <select name="selftestName<?php echo $j;?>" id="selftestName<?php echo $j;?>" style="width:100%;" class='testnameselect'>
            <option style="display:none;" value="select"> <?php if(isset($SelectTestName) &&  $SelectTestName !=''){echo $SelectTestName;} else{echo 'Select Test Name';}?></option>
                  <?php echo $medical_options;?>
           </select>
           </td>
           <td style="padding:5px;" align="center" colspan="2">
            <textarea rows="1" name="selftestOther<?php echo $j;?>" id="selftestOther<?php echo $j;?>" placeholder="<?php if(isset($EnterSelfTestName) &&  $EnterSelfTestName !=''){echo $EnterSelfTestName;} else{echo 'Enter Self Test Name..';}?>" maxlength="100" title="Enter Self Test Name" style="height:40px;width:100%;" disabled></textarea>
          </td>
           <td style="padding:5px;" align="center" colspan="3">
            <textarea rows="1" name="doctorName<?php echo $j;?>" id="doctorName<?php echo $j;?>" placeholder="<?php if(isset($EnterDoctorName) &&  $EnterDoctorName !=''){echo $EnterDoctorName;} else{echo 'Enter Doctor Name.. ';}?>" maxlength="25" title="Enter Self Test Name" style="height:40px;width:100%;"></textarea>
          </td>
          <td style="width:300px;" style="padding:5px;">
            <input type="radio" name="radio<?php echo $j;?>" value="PS" checked class="radio<?php echo $j;?> prescriptionradio"><?php if(isset($WhenStartsUpdates) &&  $WhenStartsUpdates !=''){echo $WhenStartsUpdates;} else{echo 'When the plan Starts/Updates';}?><br>
          </td>
        ...
        <tr>
          ...
          <td style="padding:5px;" align="left"><?php if(isset($Instruction) &&  $Instruction !=''){echo $Instruction;} else{echo 'Instruction:';}?></td>
          <td style="padding:5px;" align="center">
              <select name="when<?php echo $j;?>" id="when<?php echo $j;?>">
                <option style="display:none;" value="0"><?php if(isset($select) &&  $select !=''){echo $select;} else{echo 'select:';}?></option>
          ...
          <td>
            <input type="radio" name="radio<?php echo $j;?>" value="ND" class="radio<?php echo $j;?> prescriptionradio"> <?php if(isset($Noafterplanstarted) &&  $Noafterplanstarted !=''){echo $Noafterplanstarted;} else{echo 'No. Of days after plan started ';}?>&nbsp;<input type="text" size="6px" name="numofdays<?php echo $j;?>" id="numofdays<?php echo $j;?>" class="numofdays roundedinputs pointernone" maxlength="2">
          </td>
        </tr>
        <tr>
          <td style="padding:5px;" align="center" colspan="7">
            <textarea rows="1" name="selftestdesc<?php echo $j;?>" placeholder="<?php if(isset($EnterRequirementsselftest) &&  $EnterRequirementsselftest !=''){echo $EnterRequirementsselftest;} else{echo 'Enter Requirements to selftest.. ';}?>" class="forminputs2" id="selftestdesc<?php echo $j;?>" style="height:40px;width:100%;"></textarea>
          </td>
        ...
        <tr>
          ...
          <td colspan="5" style="padding:5px;">
             <div class="fileinput fileinput-new input-group" data-provides="fileinput" style="width:100%;">
                      ...
                      <span class="input-group-addon btn btn-default btn-file"><span class="fileinput-new"><?php if(isset($ClickUploadDocument) &&  $ClickUploadDocument !=''){echo $ClickUploadDocument;} else{echo 'Click To Upload A Document ';}?></span><span class="fileinput-exists">Change</span><input type="file"  name="uploadedfile<?php echo $j;?>" id="uploadedfile<?php echo $j;?>"></span>
      ...
      <div id="ActionBar" class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="position: fixed;bottom: 0;background-color: #fff;text-align: center;margin-left: -5%;width:90%;">
        <button type="button" id="addselftest" class="btns formbuttons"><?php if(isset($ADDATEST) &&  $ADDATEST !=''){echo $ADDATEST;} else{echo 'ADDATEST';}?></button>
...
$('#addselftest').click(function(){
        ...
        $('.deleterow').show();
        var first = "<tr style='border-top:4px solid #004f35;'><td style='padding:5px;' align='center' colspan='2'><select name='selftestName"+propercount+"' id='selftestName"+propercount+"' style='width:100%;' class='testnameselect'><option style='display:none;' value='select'> <?php if(isset($SelectTestName) &&  $SelectTestName !=''){echo $SelectTestName;} else{echo 'Select Test Name';}?></option>"+medical_options+"</select> </td> <td style='padding:5px;' align='center' colspan='2'><textarea rows='1' name='selftestOther"+propercount+"' id='selftestOther"+propercount+"' placeholder='<?php if(isset($EnterSelfTestName) &&  $EnterSelfTestName !=''){echo $EnterSelfTestName;} else{echo 'Enter Self Test Name..';}?>' maxlength='100' title='Enter Self Test Name' style='height:40px;width:100%;' disabled></textarea></td> <td style='padding:5px;' align='center' colspan='3'><textarea rows='1' name='doctorName"+propercount+"' id='doctorName"+propercount+"' placeholder='<?php if(isset($EnterDoctorName) &&  $EnterDoctorName !=''){echo $EnterDoctorName;} else{echo 'Enter Doctor Name.. ';}?>' maxlength='25' title='Enter Self Test Name' style='height:40px;width:100%;'></textarea></td><td style='width:300px;' style='padding:5px;'><input type='radio' name='radio"+propercount+"' value='PS' checked class='radio"+propercount+" prescriptionradio'><?php if(isset($WhenStartsUpdates) &&  $WhenStartsUpdates !=''){echo $WhenStartsUpdates;} else{echo 'When the plan Starts/Updates';}?><br></td><td><img src='images/closeRow.png' width='25px' height='auto' class='deleterow' id='"+propercount+"' title='Delete this row'></td></tr><tr><td style='padding:5px;' align='center'></td><td style='padding:5px;' align='left'><?php if(isset($Instruction) &&  $Instruction !=''){echo $Instruction;} else{echo 'Instruction:';}?></td><td style='padding:5px;' align='center'><select name='when"+propercount+"' id='when"+propercount+"'><option style='display:none;' value='0'><?php if(isset($select) &&  $select !=''){echo $select;} else{echo 'select:';}?></option>"+instruction_options+"</select></td><td style='padding:5px;' align='center'><?php if(isset($Frequency) &&  $Frequency !=''){echo $Frequency;} else{echo 'Frequency :';}?></td><td style='padding:5px;' align='center'><select name='frequency"+propercount+"' id='frequency"+propercount+"' title='Select the selfttest frequency' class='testfrequency'><option value='0' style='display:none;'><?php if(isset($select) &&  $select !=''){echo $select;} else{echo 'select:';}?></option><option value='Once'>Once</option><option value='Daily'>Daily</option><option value='Weekly'>Weekly</option><option value='Monthly'>Monthly</option></select></td><td style='padding:5px;' align='center'> <?php if(isset($Duration) &&  $Duration !=''){echo $Duration;} else{echo ' Duration :';}?></td><td style='padding:5px;' align='center'> <div style='border-radius:10px;padding:5px;background-color:#004f35;height:40px;width:150px;'><input type='text' maxlength='2' name='count"+propercount+"' id='count"+propercount+"' style='width:35px;height:30px;' class='forminputs2 roundedinputs countbox' title='Enter the duration'><select id='countType"+propercount+"' name='countType"+propercount+"' style='width:100px;float:right;height:30px;line-height:25px;background-color:#2B6D57;' title='Enter the duration'><option value='0' style='display:none;'><?php if(isset($select) &&  $select !=''){echo $select;} else{echo 'select:';}?></option><option value='Days'>Days</option><option value='Weeks'>Weeks</option><option value='Months'>Months</option></select></div></td><td><input type='radio' name='radio"+propercount+"' value='ND' class='radio"+propercount+" prescriptionradio'> <?php if(isset($Noafterplanstarted) &&  $Noafterplanstarted !=''){echo $Noafterplanstarted;} else{echo 'No. Of days after plan started ';}?>&nbsp;<input type='text' size='6px' name='numofdays"+propercount+"' id='numofdays"+propercount+"' class='numofdays roundedinputs pointernone' maxlength='2'></td></tr><tr><td style='padding:5px;' align='center' colspan='7'><textarea rows='1' name='selftestdesc"+propercount+"' placeholder='<?php if(isset($EnterRequirementsselftest) &&  $EnterRequirementsselftest !=''){echo $EnterRequirementsselftest;} else{echo 'Enter Requirements to selftest.. ';}?>' class='forminputs2' id='selftestdesc"+propercount+"' style='height:40px;width:100%;'></textarea></td><td><input type='radio' name='radio"+propercount+"' value='SD' class='radio"+propercount+" prescriptionradio' ><?php if(isset($OnSpecificDate) &&  $OnSpecificDate !=''){echo $OnSpecificDate;} else{echo 'On Specific Date: ';}?>&nbsp;<input type='text' size='10px' name='specificdate"+propercount+"' id='specificdate"+propercount+"' class='specificdate pointernone' readonly></td></tr><tr><td><td style='padding:5px;'><?php if(isset($Link) &&  $Link !=''){echo $Link;} else{echo 'Link : ';}?></td><td colspan='5' style='padding:5px;'><div class='fileinput fileinput-new input-group' data-provides='fileinput' style='width:100%;'><div class='form-control' data-trigger='fileinput'><i class='glyphicon glyphicon-file fileinput-exists'></i><span class='fileinput-filename'></span></div><span class='input-group-addon btn btn-default btn-file'><span class='fileinput-new'><?php if(isset($ClickUploadDocument) &&  $ClickUploadDocument !=''){echo $ClickUploadDocument;} else{echo 'Click To Upload A Document ';}?></span><span class='fileinput-exists'>Change</span><input type='file' name='uploadedfile"+propercount+"' id='uploadedfile"+propercount+"'></span><a href='#' class='input-group-addon btn btn-default fileinput-exists removelinkbutton' id='"+propercount+"' data-dismiss='fileinput'>Remove</a></div><input type='hidden' name='previouslink"+propercount+"' id='previouslink"+propercount+"'><input type='hidden' name='originalfilename"+propercount+"' id='originalfilename"+propercount+"'><input type='hidden' name='deletelink"+propercount+"' id='deletelink"+propercount+"'  value='0'></td><td colspan='2' style='padding:5px;'></td></tr><tr><td colspan='8'> <input type='hidden' name='selectedweekdays"+propercount+"' id='selectedweekdays"+propercount+"' class='forminputs2 editselectedweekday' readonly title='Click here to edit frequency'><input type='hidden' name='selectedmonthdays"+propercount+"' id='selectedmonthdays"+propercount+"class='forminputs2 editselectedmonthday' readonly title='Click here to edit frequency'><div class='bottomshadow' style='width:100%;color:#fff;pointer-events:none;height:12px;'><span style='display:none;'>1</span></div></td></tr>";
