...
<body>
  ...
  <div>
   <form name="frm_plan_appointments" id="frm_plan_appointments" method="post" action="plan_device.php">
    ...
    <div id="ActionBar" class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="position: fixed;bottom: 0;background-color: #fff;text-align: center;margin-left: -5%;width:90%;">
        <button type="button" id="addappointment" class="btns formbuttons">ADD AN DEVICE</button>
