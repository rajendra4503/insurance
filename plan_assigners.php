	...
	<div id="planpiper_wrapper">
		 ...
		 <div class="col-sm-10 paddingrl0" id="content_wrapper">
          ...
          ?>
		 	...
		 	<section>
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingrl0"><div id="plantitle"><span style="padding-left:238px;">Plan Assigners <?php if(isset($PlanAssigners) &&  $PlanAssigners !=''){echo '('.$PlanAssigners.')';}?></span><a href="create_user.php?lang=<?php echo $lang ;?>" style="color:#004f35;text-decoration:none;"><button type="button" class="btns" align="right" id="finished_adding">Add a Healthcare Provider <?php if(isset($AddHealthcareProvider) &&  $AddHealthcareProvider !=''){echo '('.$AddHealthcareProvider.')';}?></button></a></div></div>
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingrl0" id="plantitlelight">
        ...
        <a href="plan_assigners.php?lang=<?php echo $lang ;?>" style="color:#000;text-decoration:none;"><span class="planfilters active">Plan Assigner <?php if(isset($PlanAssigners) &&  $PlanAssigners !=''){echo '('.$PlanAssigners.')';}?></span></a>
				</div>
