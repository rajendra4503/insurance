         ...
         Duration:
          ...
          Days
	    	...
	    	<div id="dynamicPagePlusActionBar">
	    		<div class="container paddingrl0">
    <div class="col-xs-12">
        <div class="well">
            <div id="myCarousel" class="carousel slide">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <div class="row">
                            <div style="width:14.28%;float:left;padding:5px;"><textarea style="width:100%;height:200px;">1</textarea></div>
                            <div style="width:14.28%;float:left;padding:5px;"><textarea style="width:100%;height:200px;">2</textarea></div>
                            <div style="width:14.28%;float:left;padding:5px;"><textarea style="width:100%;height:200px;">3</textarea></div>
                            <div style="width:14.28%;float:left;padding:5px;"><textarea style="width:100%;height:200px;">4</textarea></div>
                            <div style="width:14.28%;float:left;padding:5px;"><textarea style="width:100%;height:200px;">5</textarea></div>
                            <div style="width:14.28%;float:left;padding:5px;"><textarea style="width:100%;height:200px;">6</textarea></div>
                            <div style="width:14.28%;float:left;padding:5px;"><textarea style="width:100%;height:200px;">7</textarea></div>
                        </div>
                        <!--/row-->
                    </div>
                    <!--/item-->
