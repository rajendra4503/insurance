                ...
                <div class="modal-content">
                  ...
                  <h5 class="modal-title" id="modalheadings"><?php if(isset($EnterPlanDetails) &&  $EnterPlanDetails !=''){echo $EnterPlanDetails;} else{echo 'Enter Plan Details';}?></h5>
                  	...
                  	<div align="left" style="padding-left:5px;font-family:RalewayRegular;color:#000;">
						<input type="text" placeholder="<?php if(isset($EnterPlanTitlehere) &&  $EnterPlanTitlehere !=''){echo $EnterPlanTitlehere;} else{echo 'Enter the Plan Title here';}?>" name="plan_name" id="plan_name" class="firstlettercaps" title="Plan Title" onkeypress='keychk(event)' maxlength="50" style="width:100%;" value="<?php echo $planname_for_current_plan;?>">
                        <textarea placeholder="<?php if(isset($Typetheplandescription) &&  $Typetheplandescription !=''){echo $Typetheplandescription;} else{echo 'Type the plan description here
