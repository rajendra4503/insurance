...
<html lang="en" class="no-js">
	...
	<div id="planpiper_wrapper">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingrl0" id="plantitlelight" style="font-size: 14px;">
        ...
        <a href="assignedplans.php?lang=<?php echo $lang ;?>" style="color:#000;text-decoration:none;"><span class="planfilters active">Assigned Plans <?php if(isset($AssignedPlans) &&  $AssignedPlans !=''){echo '('.$AssignedPlans.')';}?></span></a>
