...
if((isset($_REQUEST['prescriptionName']))&&(!empty($_REQUEST['prescriptionName']))){
	...
	$get_last_prescription_num 	= mysql_query("select max(PrescriptionNo) from MEDICATION_HEADER where PlanCode = '$current_created_plancode'");
	...
	$insert_header_details 	= " insert into MEDICATION_HEADER (Plancode, PrescriptionNo, PrescriptionName, DoctorsName, CreatedDate, CreatedBy) values ('$current_created_plancode', '$current_presc_num', '$prescription_name', '$doctor_name', now(), '$logged_userid')";
    ...
    <div class="col-sm-2 paddingrl0"  style="display:none;" id="sidebargrid">
    	...
    	<div class="navbar navbar-default" role="navigation" style="height: 100%;background-color:#004F35;position:fixed;width:16.7%;">
    		<div id="listBar">
		    	...
		    	<div id="listItems">
		    		<button type="button" id="addItemButton" class="btns">Add A Prescription<img src="images/addItem.png"></button>
		    		<?php 
		...
		$(document).ready(function() {
			...
			$('#addItemButton, #getmedications').click(function(){
				...
				if(medicationcount == 0){
					$.ajax({
						type        : "GET",
						url			: "prescriptionDefaultPage2.php",
						dataType	: "html",
