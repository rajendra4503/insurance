...
<?php 
  ...
  $prescription_name = "";
  $doctor_name = "";
  $get_presc_header = mysql_query("select PrescriptionName, DoctorsName from USER_INSTRUCTION_HEADER where PrescriptionNo = '$prescno' and PlanCode = '$plancode' and UserID='$userid'");
  ...
  ?>
        <form name="frm_plan_prescription" id="frm_plan_prescription" method="post" action="cust_inst_new.php" enctype="multipart/form-data">
      <div class="prescriptionNameBar">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="background-color:#BFBFBF;">
          <span>Template Name:</span>
        <input type="text" name="prescriptionName" id="prescriptionName" placeholder="Enter Template Name.." maxlength="25" title="Enter a name for the prescription" value="<?php echo $prescription_name;?>">
        </div>
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="background-color:#BFBFBF;">
  ...
  <?php
  $get_presc = "select `PlanCode`, `PrescriptionNo`, `RowNo`, `MedicineName`, `InstructionTypeID`, `When`, `SpecificTime`, `Instruction`, `Frequency`, `FrequencyString`,`ThresholdLimit`, `HowLong`, `HowLongType`, `IsCritical`, `ResponseRequired`, `StartFlag`, `NoOfDaysAfterPlanStarts`, `Link`, `OriginalFileName`,`StartTime`,`EndTime`, `SpecificDate` from USER_INSTRUCTION_DETAILS where PlanCode='$plancode' and PrescriptionNo = '$prescno' and UserID = '$userid'";
  //echo $get_presc;exit;
  ...
  while ($prescrow = mysql_fetch_array($get_presc_run)) {
    ...
    $StartTime             = $prescrow['StartTime'];
    $EndTime               = $prescrow['EndTime'];
      ...
      ?>
        ...
        <tr style="border-top:4px solid #004f35;">
          <td class="paddingrl5" align="center" colspan="5">
            <textarea rows="1" name="medicine<?php echo $i;?>" id="medicine<?php echo $i;?>" placeholder="Enter Instruction.." maxlength="100" title="Enter Instruction here" style="height:40px;width:100%;"><?php echo $MedicineName;?></textarea>
          </td>
        ...
        <tr>
          <td class="paddingrl5" align="left">Duration:</td>
          <td class="paddingrl5" colspan="2" align="center">
            <div class="input-group bootstrap-timepicker timepicker">
            <input value="<?php echo $StartTime;?>" id="start_time<?php echo $i;?>" name="start_time<?php echo $i;?>" type="text" placeholder="Enter Start Time" class="form-control input-small specifictime">
            <span class="input-group-addon specifictime"><i class="glyphicon glyphicon-time"></i></span>
        </div>
        </td>
        <td class="paddingrl5" colspan="2" align="center">
          <div class="input-group bootstrap-timepicker timepicker">
          <input value="<?php echo $EndTime;?>" id="end_time<?php echo $i;?>" name="end_time<?php echo $i;?>" type="text" placeholder="Enter End Time" class="form-control input-small specifictime">
          <span class="input-group-addon specifictime"><i class="glyphicon glyphicon-time"></i></span>
          </div>
        </td>
        </tr>
        ...
        <tr>
          <td align="center">Critical :<input type="checkbox" name="critical<?php echo $i;?>" id="critical<?php echo $i;?>" class="criticalcheck" title="Check this if the instruction is critical" value="Y" style="margin-left:5px;" <?php echo $CriticalSelect;?>></td>
          ...
          <td align="center">Threshold :<input type="text" maxlength="2" name="threshold<?php echo $i;?>" id="threshold<?php echo $i;?>" <?php echo $ThresholdInput;?> class="forminputs2 roundedinputs countbox" title="Enter the threshold" value='<?php echo $ThresholdLimit;?>'>
          </td>
        ...
        <tr style="border-top:4px solid #004f35;">
          <td class="paddingrl5" align="center" colspan="5">
            <textarea rows="1" name="medicine<?php echo $j;?>" id="medicine<?php echo $j;?>" placeholder="Enter Instruction.." maxlength="100" title="Enter Instruction here" style="height:40px;width:100%;"></textarea>
          </td>
          <td class="paddingrl5" align="center" colspan="2">
        ...
        <tr>
        <td align="center">Critical :<input type="checkbox" name="critical<?php echo $j;?>" id="critical<?php echo $j;?>" class="criticalcheck" title="Check this if the instruction is critical" value="Y" style="margin-left:5px;"></td>
          ...
          <td align="center">Threshold :<input type="text" maxlength="2" name="threshold<?php echo $j;?>" id="threshold<?php echo $j;?>" disabled style='width:35px;height:30px;opacity:0.2;' class="forminputs2 roundedinputs countbox" title="Enter the threshold">
          </td>

          <!-- <td></td>
          <td>Critical :<input type="checkbox" name="critical<?php echo $j;?>" id="critical<?php echo $j;?>" class="criticalcheck" title="Check this if the instruction is critical" value="Y" style="margin-left:5px;"></td>
          <td>Response :<input type="checkbox" name="response<?php echo $j;?>" id="response<?php echo $j;?>" class="responsecheck" title="Check this if a response is required" value="Y" style="margin-left:5px;"></td> -->
         <!--  <td>Link :</td>
          <td colspan="3"><input type="text" name="linkentered<?php echo $j;?>" id="linkentered<?php echo $j;?>" value="" class="forminputs2" title="Enter Link here" placeholder="Enter Link Here (Optional)"></td> -->
          <td colspan="4" style="white-space:nowrap;">
                   <div class="fileinput fileinput-new input-group" data-provides="fileinput" style="width:100%;">
          ...
          <td><input type="radio" name="radio<?php echo $i;?>" value="SD" class="radio<?php echo $i;?> prescriptionradio"> On Specific Date:&nbsp;<input type="text" size="10px" name="specificdate<?php echo $j;?>" id="specificdate<?php echo $j;?>" class='specificdate pointernone' readonly></td>
        </tr>
        <tr>
          <td colspan="8">
