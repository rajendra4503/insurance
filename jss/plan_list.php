...
<html lang="en" class="no-js">
  ...
  <div id="planpiper_wrapper">
     ...
     <div class="col-sm-10 paddingrl0" id="content_wrapper">
      ...
      <span style="padding-left:148px;">My Master Plans</span><?php if($logged_roleid !=4){?><a href="generate_plancode.php" style="color:#004f35;text-decoration:none;"><button type="button" class="btns" align="right" id="finished_adding">Add New Plan</button></a><?php }?></div></div>
