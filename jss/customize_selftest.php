...
if((isset($_REQUEST['hidden_value']))&&(!empty($_REQUEST['hidden_value']))){
	...
	if($selftestcount > '0'){
		$delete_user_header = mysql_query("delete from USER_SELF_TEST_HEADER where  PlanCode = '$plan_to_customize' and UserID='$assigned_to_user' and SelfTestID='$self_edit_id'");
		$delete_user_details = mysql_query("delete from USER_SELF_TEST_DETAILS where  PlanCode = '$plan_to_customize' and UserID='$assigned_to_user' and SelfTestID='$self_edit_id'");	
	}
	$insert_header_details 	= " insert into USER_SELF_TEST_HEADER (UserID, Plancode, SelfTestID, CreatedDate, CreatedBy) values ('$assigned_to_user','$plan_to_customize', '$current_selftest_num', now(), '$logged_userid')";
	...
	foreach ($selfttestids as $ids) {
		...
		$rand = mt_rand(1,999);
  		...
  		header("Location:customize_selftest.php");
}
?>
<!DOCTYPE html>
<html lang="en" class="no-js">
    <head>
		...
		<title>Plan Piper | Customize Self Tests</title>
    ...
    <body id="wrapper">
        <div class="col-sm-2 paddingrl0"  style="height:100%;display:none;" id="sidebargrid">
...
<button type="button" class="btns" align="right" id="finished_adding"><img src="images/finishAdd.png" style="height:20px;width:auto;margin-bottom:3px;">&nbsp;FINISH CUSTOMIZING</button></div>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<ul class="nav nav-pills nav-justified">
					...
					<li role="presentation" class="active navbartoptabs"><a href="customize_selftest.php">SELF TEST</a></li>
    	...
    	<div class="navbar navbar-default" role="navigation" style="height: 100%;background-color:#004F35;position:fixed;width:16.7%;">
    		<div id="listBar">
		    	...
		    	<div id="listItems">
		    		...
		    		<?php 
		    		$get_plan_selftests 		= "select PlanCode, SelfTestID, CreatedDate from USER_SELF_TEST_HEADER where PlanCode = '$plan_to_customize' and UserID='$assigned_to_user'";
    	...
    	<div class="col-lg-10 col-md-9 col-sm-9 col-sm-12 maincontent">
	    	<div id="dynamicPagePlusActionBar">
	    		   <form name="frm_customize_selftest" id="frm_customize_selftest" method="post" action="customize_selftest.php?id=<?php echo $self_edit_id;?>">
			     ...
			     <table id="pdata" style="float:left;padding-bottom:100px;">
			        ...
			        <?php if(isset($self_edit_id)){
			        	...
			        	$getselftests = mysql_query("select PlanCode, SelfTestID, RowNo, TestName, DoctorsName, TestDescription, InstructionID, Frequency, FrequencyString, HowLong, HowLongType,Link, ResponseRequired, StartFlag, NoOfDaysAfterPlanStarts, SpecificDate from USER_SELF_TEST_DETAILS where SelfTestID='$self_edit_id' and PlanCode='$plan_to_customize' and UserID='$assigned_to_user'");
			        	$getselftests_num = mysql_num_rows($getselftests);
				   		if($getselftests_num > 0){
				   			while ($detailsrow = mysql_fetch_array($getselftests)) {
				   				...
				   				$instruction 				= $detailsrow['InstructionID'];
    ...
    <!--END OF SHOW MONTH DAY PICKER MODAL WINDOW-->
        ...
        $('#selftestcount').val(selftestcount);
			...
			window.location.href = "customize_selftest.php?id="+appoid;
			});
					var sidebarflag = 0;
