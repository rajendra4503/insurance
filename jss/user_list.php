...
<html lang="en" class="no-js">
	...
	<div id="planpiper_wrapper">
        ...
        {
        ?>
         <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingrl0"><div id="plantitle"><span style="padding-left:226px;">Admins</span><a href="create_user.php" style="color:#004f35;text-decoration:none;"><button type="button" class="btns" align="right" id="finished_adding">Add a Healthcare Provider</button></a></div></div>
        <?php
        }
        ?>
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingrl0" id="plantitlelight">
        ...
        {
        ?>
        <a href="user_list.php" style="color:#000;text-decoration:none;"><span class="planfilters active">Admin</span></a>
        <?php
        }
        else
        {
        ?>
        <a href="user_list.php" style="color:#000;text-decoration:none;"><span class="planfilters active">Admins</span></a>
