...
if((isset($_REQUEST['hidden_value'])) && (!empty($_REQUEST['hidden_value']))){
	...
	$del_contacts 	= mysql_query("delete from PATIENT_CONTACTS where UserID = '$user_to_be_deleted'");
	...
	$del_ups 		= mysql_query("delete from USER_PHONE_SETTINGS where UserID = '$user_to_be_deleted'");
	...
	$del_access 	= mysql_query("delete from USER_ACCESS where UserID = '$user_to_be_deleted'");
	$del_details 	= mysql_query("delete from USER_DETAILS where UserID = '$user_to_be_deleted'");
	$del_umm 		= mysql_query("delete from USER_MERCHANT_MAPPING where UserID = '$user_to_be_deleted'");
...
<script type="text/javascript">
	$(document).ready(function() {
		$('.deleteplan').click(function(){
			//alert(1);
			var dltcnfrm = confirm("The User and all the related data will be deleted. Click OK to continue.");
			if(dltcnfrm == true){
