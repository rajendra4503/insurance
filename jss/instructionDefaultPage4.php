...
<?php 
  ...
  <?php
  $get_presc = "select `PlanCode`, `PrescriptionNo`, `RowNo`, `MedicineName`, `InstructionTypeID`, `ThresholdLimit`, `When`, `SpecificTime`, `Instruction`, `Frequency`, `FrequencyString`, `HowLong`, `HowLongType`, `IsCritical`, `ResponseRequired`, `StartFlag`, `NoOfDaysAfterPlanStarts`, `Link`, `OriginalFileName`, `SpecificDate`,`StartTime`,`EndTime` from INSTRUCTION_DETAILS where PlanCode='$plancode' and PrescriptionNo = '$prescno'";
  //echo $get_presc;exit;
      ...
      ?>
        ...
        <tr style="border-top:4px solid #004f35;">
          <td class="paddingrl5" align="center" colspan="5">
            <textarea rows="1" name="medicine<?php echo $i;?>" id="medicine<?php echo $i;?>" placeholder="Enter Instruction.." maxlength="250" title="Enter Instruction here" style="height:40px;width:100%;"><?php echo $MedicineName;?></textarea>
          </td>
        ...
        <tr style="border-top:4px solid #004f35;">
          <td class="paddingrl5" align="center" colspan="5">
            <textarea rows="1" name="medicine<?php echo $j;?>" id="medicine<?php echo $j;?>" placeholder="Enter Instruction.." maxlength="250" title="Enter Instruction here" style="height:40px;width:100%;"></textarea>
          </td>
          <td class="paddingrl5" align="center" colspan="2">
         ...
         <tr>
          ...
          <td class="paddingrl5" colspan="2" align="center">
            <div class="input-group bootstrap-timepicker timepicker">
            <input id="start_time<?php echo $j;?>" name="start_time<?php echo $j;?>" type="text" placeholder="Enter Start Time" class="form-control input-small specifictime">
            <span class="input-group-addon specifictime"><i class="glyphicon glyphicon-time"></i></span>
        </div>
        </td>
        <td class="paddingrl5" colspan="2" align="center">
          <div class="input-group bootstrap-timepicker timepicker">
          <input id="end_time<?php echo $j;?>" name="end_time<?php echo $j;?>" type="text" placeholder="Enter End Time" class="form-control input-small specifictime">
          <span class="input-group-addon specifictime"><i class="glyphicon glyphicon-time"></i></span>
          </div>
        </td>
        </tr>
