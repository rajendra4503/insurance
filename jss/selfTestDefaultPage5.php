...
<body>
<div>
        <form name="frm_plan_selftest" id="frm_plan_selftest" method="post" action="plan_self_new.php">
      ...
      <table id="pdata" class="table">
         <?php
  $get_self = "select PlanCode, SelfTestID, RowNo, MedicalTestID, TestName, DoctorsName, TestDescription, Instruction, Frequency, FrequencyString, HowLong, HowLongType,Link, ResponseRequired, StartFlag, NoOfDaysAfterPlanStarts, SpecificDate from SELF_TEST_DETAILS where PlanCode='$plancode' and SelfTestID = '$selfno'";
  //echo $get_self;exit;
      ...
      ?>
        ...
        <tr style="border-top:4px solid #004f35;">
          ...
          <select name="selftestName<?php echo $i;?>" id="selftestName<?php echo $i;?>" style="width:100%;" class='testnameselect'>
            <option style="display:none;" value="0">Select Test Name</option>
                  <?php echo $MedicalTestOptions;?>
           </select>
           </td>
           <td style="padding:5px;" align="center" colspan="2">
            <textarea rows="1" name="selftestOther<?php echo $i;?>" id="selftestOther<?php echo $i;?>" placeholder="Enter Self Test Name.." maxlength="100" title="Enter Self Test Name" style="height:40px;width:100%;" disabled></textarea>
          </td>
        ...
        <tr>
          ...
          <td style="padding:5px;" align="center">Instruction:</td>
          <td style="padding:5px;" align="center">
          ...
          <td style="padding:5px;" align="center">
            ...
            <input type="text" maxlength="2" name="count<?php echo $i;?>" id="count<?php echo $i;?>" style="width:35px;height:30px;" class="forminputs2 roundedinputs countbox" title="Enter the duration" value='<?php echo $HowLong;?>'>
            <select id="countType<?php echo $i;?>" name="countType<?php echo $i;?>" style="width:100px;float:right;height:30px;line-height:25px;background-color:#2B6D57;" title="Enter the duration">
              <option value="0" style="display:none;">select</option>
          ...
          <td>
            <input type="radio" name="radio<?php echo $i;?>" value="ND" class="radio<?php echo $i;?> prescriptionradio" <?php echo $NumOfDaysRadio;?>> No. Of days after plan started&nbsp;<input type="text" size="6px" name="numofdays<?php echo $i;?>" id="numofdays<?php echo $i;?>" class="numofdays roundedinputs pointernone" maxlength="2" value='<?php echo $NoOfDaysAfterPlanStarts;?>'>
          </td>
        </tr>
        <tr>
          ...
          <td><input type="radio" name="radio<?php echo $i;?>" value="SD" class="radio<?php echo $i;?> prescriptionradio" <?php echo $SpecificDateRadio;?>> On Specific Date:&nbsp;<input type="text" size="10px" name="specificdate<?php echo $i;?>" id="specificdate<?php echo $i;?>" class='specificdate pointernone' value='<?php echo $SpecificDate;?>' readonly></td>
        </tr>
        <tr>
          <td>
        ...
        for($j=1;$j<=2;$j++){
          ...
          <select name="selftestName<?php echo $j;?>" id="selftestName<?php echo $j;?>" style="width:100%;" class='testnameselect'>
           ...
           <td align="center" colspan="3" style="padding:5px;">
            <textarea rows="1" name="selftestOther<?php echo $j;?>" id="selftestOther<?php echo $j;?>" placeholder="Enter Self Test Name.." maxlength="100" title="Enter Self Test Name" style="height:40px;width:100%;" readonly></textarea>
          </td>
          <td  style="padding:5px;" align="center" colspan="2">
        ...
        <tr>
          <td style="padding:5px;" align="center" colspan="7">
            <textarea rows="1" name="selftestdesc<?php echo $j;?>" placeholder="Enter Requirements to selftest.." class="forminputs2" id="selftestdesc<?php echo $j;?>" style="height:40px;width:100%;"><?php echo $TestDescription;?></textarea>
          </td>
...
$('#addselftest').click(function(){
  alert(1);
        ...
        $('.deleterow').show();
        var first = "<tr style='border-top:4px solid #004f35;'><td style='padding:5px;' align='center' colspan='2'><select name='selftestName"+propercount+"' id='selftestName"+propercount+"' style='width:100%;' class='testnameselect'><option style='display:none;' value='0'>Select Test Name</option>"+medical_options+"</select></td><td align='center' colspan='3' style='padding:5px;'><textarea rows='1' name='selftestOther"+propercount+"' id='selftestOther"+propercount+"' placeholder='Enter Self Test Name..' maxlength='100' title='Enter Self Test Name' style='height:40px;width:100%;' readonly></textarea></td><tstyle='padding:5px;' align='center' colspan='2'><textarea rows='1' name='doctorName"+propercount+"' id='doctorName"+propercount+"' placeholder='Enter Doctor Name..' maxlength='25' title='Enter Self Test Name' style='height:40px;width:100%;'></textarea></td><td style='width:300px;' style='padding:5px;'><input type='radio' name='radio"+propercount+"' value='PS' checked class='radio"+propercount+" prescriptionradio'> When the plan Starts/Updates<br></td><td><img src='images/closeRow.png' width='25px' height='auto' class='deleterow' id='"+propercount+"' title='Delete this row'></td></tr><tr><td style='padding:5px;' align='center'></td><td style='padding:5px;' align='center'>Instruction:</td><td style='padding:5px;' align='center'><select name='when"+propercount+"' id='when"+propercount+"'><option style='display:none;' value='0'>select</option>"+instruction_options+"</select></td><td style='padding:5px;' align='center'>Frequency:</td><td style='padding:5px;' align='center'><select name='frequency"+propercount+"' id='frequency"+propercount+"' title='Select the selfttest frequency' class='testfrequency'><option value='0' style='display:none;'>select</option><option value='Once'>Once</option><option value='Daily'>Daily</option><option value='Weekly'>Weekly</option><option value='Monthly'>Monthly</option></select></td><td style='padding:5px;' align='center'>Duration :</td><td style='padding:5px;' align='center'> <div style='border-radius:10px;padding:5px;background-color:#004f35;height:40px;width:150px;'><input type='text' maxlength='2' name='count"+propercount+"' id='count"+propercount+"' style='width:35px;height:30px;' class='forminputs2 roundedinputs countbox' title='Enter the duration'><select id='countType"+propercount+"' name='countType"+propercount+"' style='width:100px;float:right;height:30px;line-height:25px;background-color:#2B6D57;' title='Enter the duration'><option value='0' style='display:none;'>select</option><option value='Days'>Days</option><option value='Weeks'>Weeks</option><option value='Months'>Months</option></select></div></td><td><input type='radio' name='radio"+propercount+"' value='ND' class='radio"+propercount+" prescriptionradio'> No. Of days after plan started&nbsp;<input type='text' size='6px' name='numofdays"+propercount+"' id='numofdays"+propercount+"' class='numofdays roundedinputs pointernone' maxlength='2'></td></tr><tr><td style='padding:5px;' align='center' colspan='7'><textarea rows='1' name='selftestdesc"+propercount+"' placeholder='Enter Requirements to selftest..' class='forminputs2' id='selftestdesc"+propercount+"' style='height:40px;width:100%;'><?php echo $TestDescription;?></textarea></td><td><input type='radio' name='radio"+propercount+"' value='SD' class='radio"+propercount+" prescriptionradio'> On Specific Date:&nbsp;<input type='text' size='10px' name='specificdate"+propercount+"' id='specificdate"+propercount+"' class='specificdate pointernone' readonly></td></tr><tr><td><tstyle='padding:5px;'>Link :</td> <td colspan='5style='padding:5px;'><input type='text' name='linkentered"+propercount+"' id='linkentered"+propercount+"class='forminputs2' title='Enter Link here' placeholder='Enter Link Here (Optional)'></td><td colspan='2' style='padding:5px;'></td></td></tr><tr><td colspan='8'><input <?php echo $SpecificTimeType;?> name='specifictime"+propercount+"' id='specifictime"+propercount+"' class='editedspecifictimes forminputs2' readonly title='Click here to edit specific times'></td></tr><tr><td colspan='8'><input type='hidden' name='selectedweekdays"+propercount+"' id='selectedweekdays"+propercount+"' value=' class='forminputs2 editselectedweekday' readonly title='Click here to edit frequency'> <input type='hidden' name='selectedmonthdays"+propercount+"' id='selectedmonthdays"+propercount+"' value=' class='forminputs2 editselectedmonthday' readonly title='Click here to edit frequency'><div class='bottomshadow' style='width:100%;color:#fff;pointer-events:none;height:12px;'><span style='display:none;'>1</span></div></td></tr>";
