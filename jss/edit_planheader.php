...
//Get plan details
$get_plan_details = "select t1.PlanName, t1.PlanDescription, t1.PlanCoverImagePath, t1.CategoryID, t2.CategoryName from USER_PLAN_HEADER as t1, CATEGORY_MASTER as t2  where PlanCode = '$plan_to_customize' and t1.CategoryID = t2.CategoryID and t1.UserID = '$assigned_to_user'";
            ...
            $get_plan_details_count = mysql_num_rows($get_plan_details_run);
                    if($get_plan_details_count > 0){
                      while ($plan_details = mysql_fetch_array($get_plan_details_run)) {
                        ...
                        $plandet_desc     = $plan_details['PlanDescription'];
                        $fullfilename     = $plan_details['PlanCoverImagePath'];
...
if(isset($_REQUEST['plan_name']) && (!empty($_REQUEST['plan_name']))){
	$plan_name 				  = mysql_real_escape_string($_REQUEST['plan_name']);
	$plan_desc 				  = mysql_real_escape_string($_REQUEST['plan_desc']);
...
$rand = mt_rand(1,999);
  $update_header = mysql_query("update USER_PLAN_HEADER set PlanName = '$plan_name', PlanDescription = '$plan_desc', PlanCoverImagePath ='$fullfilename', PlanStatus = '$rand' where PlanCode='$plan_to_customize' and UserID = '$assigned_to_user'");
...
<html lang="en" class="no-js">
	...
	<div id="planpiper_wrapper">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingrl0"><div id="plantitle">Customize Plan Details</div></div>
		 	<section>
		 		<div class="col-lg-offset-1 col-lg-10 col-lg-offset-1 col-md-offset-1 col-md-10 col-md-offset-1 col-sm-12 col-xs-12">
								<form name="frm_customize_plan" id="frm_customize_plan" method="post" enctype="multipart/form-data" action="edit_planheader.php">
                                <div style="margin-top:60px;z-index:200;">
                                 <div style="height:50px;margin-left:40px;" id="error" >
									...
									<div class="col-lg-offset-1 col-lg-8 col-md-offset-1 col-md-8 col-sm-offset-1 col-sm-8 col-xs-offset-1 col-xs-8" style="z-index:200;padding-top:5px;">
											<input type="text" placeholder="Enter the Plan Title here" name="plan_name" id="plan_name" class="firstlettercaps" title="Plan Title" onkeypress='keychk(event)' autofocus value="<?php echo $plandet_name;?>">
                                             
											<textarea placeholder="Type the plan description here" id="plan_desc" name="plan_desc" title="Plan Description" rows="4" style="resize:none;"  maxlength="499"><?php echo $plandet_desc;?></textarea>
								...
								<div class="col-lg-offset-1 col-lg-10 col-lg-offset-1 col-md-offset-1 col-md-10 col-md-offset-1 col-sm-12 col-xs-12" id="coverimageforplan" style="z-index:0;">
									<div id="targetLayer"><img src="<?php echo $plandet_path;?>" style="width:100%;padding:0px;margin-0px;"></div>
