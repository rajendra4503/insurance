...
<body>
  <div>
   <form name="frm_plan_selftest" id="frm_plan_selftest" method="post" action="cust_self_new.php" enctype="multipart/form-data">
      ...
      <table id="pdata" class="table">
        <?php
  $get_self = "select UserID, PlanCode, SelfTestID, RowNo, MedicalTestID, TestName, DoctorsName, TestDescription, InstructionID, Frequency, FrequencyString, HowLong, HowLongType, Link, OriginalFileName, ResponseRequired, StartFlag, NoOfDaysAfterPlanStarts, SpecificDate from USER_SELF_TEST_DETAILS where PlanCode='$plancode' and SelfTestID = '$selfno' and UserID = '$userid'";
  //echo $get_self;exit;
