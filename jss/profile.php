...
<html lang="en" class="no-js">
	...
	<div id="planpiper_wrapper">
		 ...
		 <div class="col-sm-10 paddingrl0" id="content_wrapper">
		 	...
		 	<section>
		 		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingrl0"><div id="plantitle"><span style="padding-left:117px;">Profile</span><button type="button" class="btns" align="right" id="store_profile">Store Profile</button></div></div>
			 	...
			 	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><div id="pageheading">User Details</div>
			 	</div>
			 	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						
						    <span class="asterisk"></span><input type="text" required class="forminputs3 nonumbers firstlettercaps" placeholder="FIRST NAME" name="firstname" id="firstname" maxlength="20" value="<?php echo $det_firstname;?>">
							<span class="asterisk"></span><input type="text" required class="forminputs3 nonumbers firstlettercaps" placeholder="LAST NAME" name="lastname" id="lastname" maxlength="20"  value="<?php echo $det_lastname;?>">					
						    <span class="asterisk"></span><input type="email" required placeholder="EMAIL ID" name="email" id="email" class="forminputs3" maxlength="50" value="<?php echo $det_emailid; ?>">
						    <span class="asterisk"></span><input type="text" required  maxlength="10" placeholder="MOBILE NUMBER" name="mobilenumber" id="mobilenumber" class="forminputs3 onlynumbers" value="<?php echo $det_mobileno;?>">
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						 ...
						 <input type="text" class="forminputs3" placeholder="Social Media" name="social_media_link" id="social_media_link" maxlength="250" value="<?php echo $social_media_link;?>">
