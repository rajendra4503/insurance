...
if((isset($_REQUEST['prescriptionName']))&&(!empty($_REQUEST['prescriptionName']))){
	...
	foreach ($medicineids as $ids) {
		...
		$insert_medicine_details = "insert into INSTRUCTION_DETAILS (`PlanCode`,`PrescriptionNo`,`RowNo`,`MedicineName`,`ThresholdLimit`,`When`,`SpecificTime`,`Instruction`,`Link`, `Frequency`,`FrequencyString`,`HowLong`,`HowLongType`,`IsCritical`,`ResponseRequired`,`StartFlag`,`NoOfDaysAfterPlanStarts`,`SpecificDate`,`CreatedDate`,`CreatedBy`) values ('$plancode_for_current_plan', '$current_presc_num', '$count', '$medicinename','$threshold','$when','$specifictime','$instruction','$linkentered','$frequency','$frequencystring','$howlong','$howlongtype','$iscritical','$responserequired','$startflag','$numberofdaysafterplan','$specific_date', now(), '$logged_userid')";
	...
	//$specifictime = date('H:i:s',strtotime($specifictime));
	$insert_medicine_details = "insert into INSTRUCTION_DETAILS (`PlanCode`,`PrescriptionNo`,`RowNo`,`MedicineName`,`ThresholdLimit`,`When`,`Instruction`,`Link`, `Frequency`,`FrequencyString`,`HowLong`,`HowLongType`,`IsCritical`,`ResponseRequired`,`StartFlag`,`NoOfDaysAfterPlanStarts`,`SpecificDate`,`CreatedDate`,`CreatedBy`) values ('$plancode_for_current_plan', '$current_presc_num', '$count', '$medicinename','$threshold','$when','$instruction','$linkentered','$frequency','$frequencystring','$howlong','$howlongtype','$iscritical','$responserequired','$startflag','$numberofdaysafterplan','$specific_date', now(), '$logged_userid')";
