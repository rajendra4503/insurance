...
if((isset($_REQUEST['prescriptionName']))&&(!empty($_REQUEST['prescriptionName']))){
	...
	$end_time = mysql_real_escape_string(trim(htmlspecialchars($_REQUEST["end_time$ids"])));
		...
		$insert_medicine_details = "insert into INSTRUCTION_DETAILS (`PlanCode`,`PrescriptionNo`,`RowNo`,`MedicineName`, `InstructionTypeID`, `ThresholdLimit`,`When`,`SpecificTime`,`Instruction`,`Link`, `OriginalFileName`, `Frequency`,`FrequencyString`,`HowLong`,`HowLongType`,`IsCritical`,`ResponseRequired`,`StartFlag`,`NoOfDaysAfterPlanStarts`,`SpecificDate`,`StartTime`,`EndTime`,`CreatedDate`,`CreatedBy`) values ('$plancode_for_current_plan', '$current_presc_num', '$count', '$medicinename', '$instructiontypes', '$threshold','$when','$specifictime','$instruction','$fullpath','$filename','$frequency','$frequencystring','$howlong','$howlongtype','$iscritical','$responserequired','$startflag','$numberofdaysafterplan','$specific_date','$start_time','$end_time',now(), '$logged_userid')";
	...
	$insert_medicine_details = "insert into INSTRUCTION_DETAILS (`PlanCode`, `PrescriptionNo`, `RowNo`, `MedicineName`, `InstructionTypeID`, `ThresholdLimit`, `When`, `Instruction`, `Link`, `OriginalFileName`, `Frequency`,`FrequencyString`,`HowLong`,`HowLongType`,`IsCritical`,`ResponseRequired`,`StartFlag`,`NoOfDaysAfterPlanStarts`,`SpecificDate`,`StartTime`,`EndTime`,`CreatedDate`,`CreatedBy`) values ('$plancode_for_current_plan', '$current_presc_num', '$count', '$medicinename', '$instructiontypes', '$threshold','$when','$instruction','$fullpath','$filename','$frequency','$frequencystring','$howlong','$howlongtype','$iscritical','$responserequired','$startflag','$numberofdaysafterplan','$specific_date','$start_time','$end_time',now(), '$logged_userid')";
