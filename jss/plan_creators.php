...
<html lang="en" class="no-js">
	...
	<div id="planpiper_wrapper">
		 ...
		 <div class="col-sm-10 paddingrl0" id="content_wrapper">
		 	...
		 	<section>
     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingrl0"><div id="plantitle"><span style="padding-left:224px;">Plan Creators</span><a href="create_user.php" style="color:#004f35;text-decoration:none;"><button type="button" class="btns" align="right" id="finished_adding">Add a Healthcare Provider</button></a></div></div>
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingrl0" id="plantitlelight">
        ...
        <a href="plan_creators.php" style="color:#000;text-decoration:none;"><span class="planfilters active">Plan Creator</span></a>
        <a href="plan_assigners.php" style="color:#000;text-decoration:none;"><span class="planfilters">Plan Assigner</span></a>
				</div>
