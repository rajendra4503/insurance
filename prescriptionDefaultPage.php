...
<body>
  <div>
   <form name="frm_plan_prescription" id="frm_plan_prescription" method="post" action="plan_medication.php">
      <div class="prescriptionNameBar">
        ...
        <input type="text" name="prescriptionName" id="prescriptionName" placeholder="Enter Prescription Name.." maxlength="25" title="Enter a name for the prescription">
        </div>
      ...
      <tr id="pheader1">
        ...
        <tr>
          <td><textarea rows="2" name="medicine1" id="medicine1" placeholder="Enter Medicine Name.." maxlength="100" title="Enter Medicine Name here"></textarea></td>
          <td>
            <select name="when1" id="when1" title="Select the medicine dosage" class="whenshorthand">
              <option value="0" style="display:none;">select</option>
              <?php echo $shorthand_options;?>
            </select>
          </td>
          <td>
            <select name="instruction1" id="instruction1" title="Select the medicine instruction">
              <option value="0" style="display:none;">select</option>
          ...
          <td>
            <select name="frequency1" id="frequency1" title="Select the medicine frequency" class="medfrequency">
              <option value="0" style="display:none;">select</option>
          ...
          <td><input type="checkbox" name="critical1" id="critical1" class="criticalcheck" title="Check this if the medicine is critical" value="Y"></td>
        ...
        <tr>
          <td><textarea rows="2" name="medicine2" id="medicine2" placeholder="Enter Medicine Name.." title="Enter Medicine Name here" maxlength="100"></textarea></td>
          <td>
            <select name="when2" id="when2" title='Select the medicine dosage' class="whenshorthand">
              <option value="0" style="display:none;">select</option>
              <?php echo $shorthand_options;?>
            </select>
          </td>
          <td>
            <select name="instruction2" id="instruction2" title='Select the medicine instruction'>
              <option value="0" style="display:none;">select</option>
              <option value="Before Food">Before Food</option>
              <option value="With Food">With Food</option>
              <option value="After Food">After Food</option>
          ...
          <td>
            <select name="frequency2" id="frequency2" title='Select the medicine frequency' class="medfrequency">
              <option value="0" style="display:none;">select</option>
              <option value="Once">Once</option>
              <option value="Daily">Daily</option>
              <option value="Weekly">Weekly</option>
          ...
          <td><input type="checkbox" name="critical2" id="critical2" class="criticalcheck" title='Check this if the medicine is critical' value="Y"></td>
        ...
        <tr>
          <td><textarea rows="2" name="medicine3" id="medicine3" placeholder="Enter Medicine Name.." title="Enter Medicine Name here" maxlength="100"></textarea></td>
          <td>
            <select name="when3" id="when3" title='Select the medicine dosage' class="whenshorthand">
              <option value="0" style="display:none;">select</option>
              <?php echo $shorthand_options;?>
            </select>
          </td>
          <td>
            <select name="instruction3" id="instruction3" title='Select the medicine instruction'>
              <option value="0" style="display:none;">select</option>
              <option value="Before Food">Before Food</option>
              <option value="With Food">With Food</option>
              <option value="After Food">After Food</option>
          ...
          <td>
            <select name="frequency3" id="frequency3" title='Select the medicine frequency' class="medfrequency">
              <option value="0" style="display:none;">select</option>
              <option value="Once">Once</option>
              <option value="Daily">Daily</option>
              <option value="Weekly">Weekly</option>
          ...
          <td><input type="checkbox" name="critical3" id="critical3" class="criticalcheck" title='Check this if the medicine is critical' value="Y"></td>
